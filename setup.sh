...
main() {
  ...
  show_progress "Step 5/6: Configuration file creation"
  ./setup-files/05-create-templates.sh "$DOMAIN_NAME"
  check_success "configuration file creation"
  
  # Step 6: Service launch
  show_progress "Step 6/6: Service launch"
  ./setup-files/06-start-services.sh
